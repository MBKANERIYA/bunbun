    ...
    <div className="bg-light min-vh-100 py-5">
      <div className="container bg-white rounded shadow p-4 p-md-5">
        ...
        <ul className="mb-4">
          ...
          <li className="mb-2"><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Privacy Policy) refers to bunbun clothing, C-WING 6129 TO 6131,6092-6094 AVADH RITURAJ TEXTILE HUB OPP.MIDAS SQUARE GODADARA SURAT.</li>
        ...
        <h2 className="h4 fw-semibold mt-5 mb-3">Collecting and Using Your Personal Data</h2>
        
        <h3 className="h5 fw-semibold mt-4 mb-2">Types of Data Collected</h3>
        
        <h4 className="h6 fw-semibold mt-3 mb-2">Personal Data</h4>
        ...
        <h4 className="h6 fw-semibold mt-3 mb-2">Usage Data</h4>
        ...
        <h4 className="h6 fw-semibold mt-3 mb-2">Tracking Technologies and Cookies</h4>
        ...
        <h2 className="h4 fw-semibold mt-5 mb-3">Use of Your Personal Data</h2>
        ...
        <h2 className="h4 fw-semibold mt-5 mb-3">Retention of Your Personal Data</h2>
        ...
        <h4 className="h6 fw-semibold mt-3 mb-2">Account Information</h4>
        <ul>
        ...
        <h4 className="h6 fw-semibold mt-3 mb-2">Customer Support Data</h4>
        <ul>
        ...
        <h2 className="h4 fw-semibold mt-5 mb-3">Transfer of Your Personal Data</h2>
        ...
        <h2 className="h4 fw-semibold mt-5 mb-3">Delete Your Personal Data</h2>
        ...
        <h2 className="h4 fw-semibold mt-5 mb-3">Disclosure of Your Personal Data</h2>
        <h4 className="h6 fw-semibold mt-3 mb-2">Business Transactions</h4>
        <p>If the Company is involved in a merger, acquisition or asset sale, Your Personal Data may be transferred. We will provide notice before Your Personal Data is transferred and becomes subject to a different Privacy Policy.</p>
        
        <h4 className="h6 fw-semibold mt-3 mb-2">Law enforcement</h4>
        <p>Under certain circumstances, the Company may be required to disclose Your Personal Data if required to do so by law or in response to valid requests by public authorities (e.g. a court or a government agency).</p>
        
        <h4 className="h6 fw-semibold mt-3 mb-2">Other legal requirements</h4>
        ...
        <h2 className="h4 fw-semibold mt-5 mb-3">Security of Your Personal Data</h2>
        ...
        <h2 className="h4 fw-semibold mt-5 mb-3">Children's Privacy</h2>
        ...
        <h2 className="h4 fw-semibold mt-5 mb-3">Changes to this Privacy Policy</h2>
